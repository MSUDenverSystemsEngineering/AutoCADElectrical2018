...
Try {
	...
	[string]$appName = 'AutoCAD Electrical'
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
        ...
        # Check if other AutoCAD application is installed, only uninstall AutoCAD Electrical components:
        If ((Get-InstalledApplication -ProductCode '{28B89EEF-1000-0000-0102-CF3F3A09B77D}') -Or (Get-InstalledApplication -ProductCode '{28B89EEF-1005-0000-0102-CF3F3A09B77D}')){
